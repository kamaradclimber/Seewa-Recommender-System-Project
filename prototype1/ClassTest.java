...
public class ClassTest {
	...
	try {
		...
		System.out.println("Ba oui ya un probleme, va falloir le g�rer Johnny");
		e.printStackTrace();
	}
	if (false) {
	try {
		...
		if (clusters.size()==0) {
			...
			System.out.println("  -> La liste des lcusters est vide (peut etre qu'il n'y a rien dans la base de donn�es...");
		} else {
