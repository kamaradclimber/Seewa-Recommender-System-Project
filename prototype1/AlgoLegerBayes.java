...
//test
	...
	public Recommendation answers(Request req) throws ExceptionRecoNotValid {
		...
		if (req.getUrl()=="test" ) 
		{
			...
			DataUPage jeanMichLEquipe= new DataUPage(new ObjectId(),jeanMichId, 0.5, "www.lï¿½quipe.fr");
			...
			DataUPage jeanJauresLEquipe= new DataUPage(new ObjectId(),jeanJauresId, 0.6, "www.lï¿½quipe.fr");
			DataUPage jeanJauresLHuma= new DataUPage(new ObjectId(),jeanJauresId, 0.9, "www.lhumanitï¿½.fr");
